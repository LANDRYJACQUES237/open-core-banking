...
/**
 * Bareme de frais : une part variable, une part fixe, un plafond facultatif.
 *
 ...
 *
 * <p>Le bareme est partage entre encaissement et decaissement ; les <b>taux</b>, eux, ne
 * le sont pas : chaque sens a sa propre configuration.
 */
public abstract class FeeSchedule {
    ...
    protected Money compute(Money amount) {
